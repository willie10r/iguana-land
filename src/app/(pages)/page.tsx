...
export default function Home() {
  return (
    < >
      <section className='flex flex-row mb-48'>
        <div className='text-center mx-40 mt-28'>
          <h1 className=' md:font-bold text-3xl mb-10'>Taking care of your lizard!</h1>
          <p className=' mb-10 text-2xl'>
            Human-lizard bonding is the relationship between lizards and humans. That take time to develop into somthing special.
            One of the best place&apos;s to start is the diet.
            Iguana&apos;s love food so finding out work&apos;s best for yours will make the taming process that much easy</p>
      ...
      <section className='flex justify-center my-20  mb-48'>
        <div>
          <h2 className='md:font-bold text-3xl mb-10'>Services Category </h2>
          <ul className='flex flex-row'>
            <li className='w-40 bg-green-500 inline-block border rounded-lg py-2 px-4 text-black hover:text-white font-semibold mr-10 h-52'>
      ...
      <section className='flex flex-row'>
        ...
        />
        <div className='text-center mx-40 mt-28'>
          <h2 className=' md:font-bold text-3xl mb-10'>Lizards do speak, but only to those who know how to listen.</h2>
          <p className='mb-10 text-2xl'>
            Pet iguanas aren&apos;t easy animals to care for. Despite their friendly,
            dragon-like appearance during their youth, iguanas can grow up to be about 1.5 meters long and weigh over 15 pounds. Plus,
